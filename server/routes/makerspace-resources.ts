...
router.get('/makerspaces/:id/resources', auth, async (req: Request, res: Response) => {
  try {
    ...
    const resources = await db.select({
      ...
      serialNumber: makerspaceResources.serialNumber,
      warranty: makerspaceResources.warranty,
      maintenanceSchedule: makerspaceResources.maintenanceSchedule,
      lifeExpectancy: makerspaceResources.lifeExpectancy,
