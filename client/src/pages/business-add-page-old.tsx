                                  ...
                                  <TableCell>
                                    <div className="flex items-center">
                                      ...
                                      <div>
                                        ...
                                        <div className="text-xs text-gray-500">{member.phone || 'No contact'}</div>
                                      </div>
                                    </div>
                                  </TableCell>
                                  <TableCell>
            ...
            <TabsContent value="mentors" className="mt-6">
              ...
              >
                <Card className="border-gray-100 shadow-md overflow-hidden">
                  ...
                  <CardContent>
                    {Array.isArray(mentorAssignments) && mentorAssignments.length > 0 ? (
                      <div className="overflow-x-auto">
                        <Table>
                          <TableHeader style={{ background: "#f9fafb" }}>
                            <TableRow>
                          ...
                          <TableBody>
                            {mentorAssignments.map((assignment: MentorAssignment) => (
                              <motion.tr
                              ...
                              >
                                ...
                                <TableCell className="text-right">
                                  <TooltipProvider>
                                    <Tooltip>
                                      <TooltipTrigger asChild>
                                        <Button variant="ghost" size="icon" className="h-8 w-8 text-gray-500 hover:text-amber-500">
