  ...
  const form = useForm<ProfileFormData>({
    ...
    defaultValues: (() => {
      ...
      return {
        ...
        implementingPartnerName: profileData?.implementingPartnerName || '',
        ...
        programDetails: profileData?.programDetails || '',
        programContactPerson: profileData?.programContactPerson || '',
        programContactPhoneNumber: profileData?.programContactPhoneNumber || '',
              ...
              <TabsContent value="extras">
                <div className="space-y-4">
                  ...
                  <div className="space-y-4 pt-2">
                    <h3 className="font-medium">DARE Model</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField
                        control={form.control}
                        name="dareModel"
                  ...
                  <div className="space-y-4 pt-4 border-t mt-4">
                    ...
                    <FormField
                      control={form.control}
                      name="hostCommunityStatus"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Host Community Status</FormLabel>
                          <FormControl>
                            <Input placeholder="Community status" {...field} value={field.value || ''} />
                          </FormControl>
                          <FormDescription>
                            Status of the community in relation to hosting refugees
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
